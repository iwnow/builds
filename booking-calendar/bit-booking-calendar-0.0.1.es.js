...
function add_css$3(target) {
  append_styles(target, "bit-192pqs4", ".form-field.bit-192pqs4.bit-192pqs4{display:flex;flex-direction:column;margin-top:10px}.form-field.bit-192pqs4 label.bit-192pqs4{margin-bottom:5px}.fio.bit-192pqs4.bit-192pqs4{margin-top:5px}.input.bit-192pqs4.bit-192pqs4{padding:5px 10px;border-color:var(--bit-ca-border-color);border-style:solid;border-width:1px;border-radius:4px}.input.bit-192pqs4.bit-192pqs4:focus,.input.bit-192pqs4.bit-192pqs4:focus-visible{outline-width:1px;outline-style:solid;outline-color:var(--bit-ca-accent-lighter-color)}.booking-confirm.bit-192pqs4.bit-192pqs4{display:flex;color:#464646}.summary.bit-192pqs4.bit-192pqs4{flex:1 1 auto;padding:16px;background-color:var(--bit-ca-bg);border-radius:4px;border:1px solid #ddd}.summ.bit-192pqs4.bit-192pqs4{display:flex;justify-content:space-between;padding-right:13px;font-size:1.15rem}.place-name.bit-192pqs4.bit-192pqs4{font-weight:500}.contact.bit-192pqs4.bit-192pqs4{flex:1 1 auto;padding:0 16px}.confirm-btn.bit-192pqs4.bit-192pqs4{width:100%;padding:12px 20px;margin-top:20px;background-color:var(--bit-ca-accent-color);color:white;font-weight:700;border:none;border-radius:4px;cursor:pointer}.confirm-btn.bit-192pqs4.bit-192pqs4:disabled{background-color:var(--bit-ca-accent-lighter-color)}.section.bit-192pqs4.bit-192pqs4{margin-top:1rem}.products.bit-192pqs4.bit-192pqs4{margin-top:1rem}.product.bit-192pqs4.bit-192pqs4{display:flex;padding:2px 0;margin-bottom:6px;border-radius:4px}.product.bit-192pqs4>div.bit-192pqs4{padding:4px 12px}.product.bit-192pqs4>div.bit-192pqs4:first-child{padding-left:0}.product-day.bit-192pqs4.bit-192pqs4{min-width:70px}.product-amount.bit-192pqs4.bit-192pqs4{min-width:80px;text-align:right}.product-duration.bit-192pqs4.bit-192pqs4{min-width:100px;text-align:right}@media(max-width: 640px){.booking-confirm.bit-192pqs4.bit-192pqs4{flex-direction:column}.contact.bit-192pqs4.bit-192pqs4{margin-top:1rem}.fio.bit-192pqs4.bit-192pqs4{display:flex;flex-direction:column}.fio.bit-192pqs4 input.bit-192pqs4:first-child{margin-bottom:10px}}");
}
...
function create_if_block_2$2(ctx) {
  ...
  return {
    c() {
      div = element("div");
      t = text(ctx[2]);
      attr(div, "class", "place-name bit-192pqs4");
    },
    m(target, anchor) {
...
function create_if_block$2(ctx) {
  ...
  return {
    c() {
      div = element("div");
      t = text(t_value);
      attr(div, "class", "section bit-192pqs4");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, t);
...
function create_each_block$1(ctx) {
  ...
  return {
    c() {
      ...
      div3 = element("div");
      t6 = space();
      attr(div0, "class", "product-day bit-192pqs4");
      attr(div1, "class", "product-time bit-192pqs4");
      attr(div2, "class", "product-duration bit-192pqs4");
      attr(div3, "class", "product-amount bit-192pqs4");
      attr(div4, "class", "product bit-192pqs4");
    },
    m(target, anchor) {
...
function create_fragment$3(ctx) {
  ...
  return {
    c() {
      ...
      t18 = text(t18_value);
      attr(div0, "class", "products bit-192pqs4");
      attr(hr, "class", "line");
      attr(div3, "class", "summ bit-192pqs4");
      attr(div4, "class", "summary bit-192pqs4");
      attr(input0, "class", "input bit-192pqs4");
      attr(input0, "type", "text");
      attr(input0, "name", "name");
      attr(input0, "placeholder", "\u0418\u043C\u044F");
      attr(input1, "class", "input bit-192pqs4");
      attr(input1, "type", "text");
      attr(input1, "name", "surname");
      attr(input1, "placeholder", "\u0424\u0430\u043C\u0438\u043B\u0438\u044F");
      attr(div6, "class", "fio bit-192pqs4");
      attr(label0, "for", "");
      attr(label0, "class", "bit-192pqs4");
      attr(input2, "class", "input bit-192pqs4");
      attr(input2, "type", "tel");
      attr(input2, "name", "phone");
      attr(div7, "class", "form-field bit-192pqs4");
      attr(label1, "for", "");
      attr(label1, "class", "bit-192pqs4");
      attr(input3, "class", "input bit-192pqs4");
      attr(input3, "type", "email");
      attr(input3, "name", "email");
      attr(input3, "placeholder", "e-mail");
      attr(div8, "class", "form-field bit-192pqs4");
      attr(button, "class", "confirm-btn bit-192pqs4");
      attr(button, "type", "button");
      button.disabled = ctx[6];
      attr(div9, "class", "contact bit-192pqs4");
      attr(div10, "class", "booking-confirm bit-192pqs4");
    },
    m(target, anchor) {
...
function add_css$1(target) {
  append_styles(target, "bit-18fqww7", ".overlay.bit-18fqww7.bit-18fqww7{position:absolute;top:0;bottom:0;right:0;left:0;padding:1rem;background-color:rgba(0, 0, 0, 0.5);display:flex;justify-content:center}.overlay[data-position=center].bit-18fqww7.bit-18fqww7{align-items:center}.overlay[data-position=top].bit-18fqww7.bit-18fqww7{align-items:flex-start}.overlay[data-position=bottom].bit-18fqww7.bit-18fqww7{align-items:flex-end}.overlay.bit-18fqww7 .content.bit-18fqww7{background-color:white;border-radius:4px;padding:10px;min-width:480px}.overlay.bit-18fqww7 .header.bit-18fqww7{display:flex;font-size:1.2rem;font-weight:500;align-items:center;justify-content:space-between;margin-bottom:0.8rem}.overlay.bit-18fqww7 .close-icon{cursor:pointer;color:rgba(0, 0, 0, 0.5)}.overlay.bit-18fqww7 .close-icon:hover{color:currentColor}");
}
...
function create_fragment$1(ctx) {
  ...
  return {
    c() {
      ...
      if (default_slot)
        default_slot.c();
      attr(div1, "class", "header bit-18fqww7");
      attr(div2, "class", "content bit-18fqww7");
      attr(div3, "class", "overlay bit-18fqww7");
      attr(div3, "data-position", ctx[1]);
    },
    m(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = listen(div3, "click", ctx[4]);
        mounted = true;
      }
    },
    p(ctx2, [dirty]) {
      ...
      if (!current || dirty & 2) {
        attr(div3, "data-position", ctx2[1]);
      }
    },
    i(local) {
      if (current)
...
function add_css(target) {
  append_styles(target, "bit-kl0xqo", ':root{--bit-ca-bg:#fafafa;--bit-ca-bg2:#f5f5f5;--bit-ca-secondary-color:#999999;--bit-ca-secondary-color2:#767676;--bit-ca-border-color:#ddd;--bit-ca-accent-color:#5b21b6;--bit-ca-accent-lighter-color:#7c3aed}.calendar.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{font-family:-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif;font-size:14px;width:980px;margin:0 auto;padding:10px;background-color:var(--bit-ca-bg, #fafafa);position:relative}.calendar.bit-kl0xqo .basket-panel.bit-kl0xqo.bit-kl0xqo{padding:0 1rem 2rem 1rem}.calendar.bit-kl0xqo .basket-panel__section-tabs.bit-kl0xqo.bit-kl0xqo{height:35px;display:flex;width:fit-content;margin-bottom:2rem}.calendar.bit-kl0xqo .basket-panel__section-tab.bit-kl0xqo.bit-kl0xqo{height:35px;padding:0 0.5rem;display:flex;align-items:center;justify-content:center;background-color:white;border-radius:4px;margin-right:10px;border:1px solid transparent}.calendar.bit-kl0xqo .basket-panel__section-tab.tab-active.bit-kl0xqo.bit-kl0xqo{background-color:var(--bit-ca-accent-color, #5b21b6);color:var(--bit-ca-accent-contrast-color, white)}.calendar.bit-kl0xqo .basket-panel__section-tab.bit-kl0xqo.bit-kl0xqo:not(.tab-active){cursor:pointer;border:1px solid #eee}.calendar.bit-kl0xqo .basket-panel__section-tab.bit-kl0xqo.bit-kl0xqo:not(.tab-active):hover{background-color:var(--bit-ca-hover-color, #ddd)}.calendar.bit-kl0xqo .basket-panel__summary.bit-kl0xqo.bit-kl0xqo{height:fit-content;display:flex;justify-content:space-between;align-items:center}.calendar.bit-kl0xqo .basket-panel__basket.bit-kl0xqo.bit-kl0xqo{display:flex;flex:1 1 auto;height:100%;min-height:120px}.calendar.bit-kl0xqo .basket-panel__products.bit-kl0xqo.bit-kl0xqo{flex:1 1 auto;display:flex;flex-direction:column;justify-content:center;padding-right:8px}.calendar.bit-kl0xqo .basket-panel__product.bit-kl0xqo.bit-kl0xqo{display:flex;padding:2px;background-color:white;margin-bottom:6px;border-radius:4px;border:1px solid #eee}.calendar.bit-kl0xqo .basket-panel__product.bit-kl0xqo>div.bit-kl0xqo{padding:4px 12px}.calendar.bit-kl0xqo .basket-panel__product.bit-kl0xqo>div.bit-kl0xqo:first-child{padding-left:8px}.calendar.bit-kl0xqo .basket-panel__product-day.bit-kl0xqo.bit-kl0xqo{min-width:70px}.calendar.bit-kl0xqo .basket-panel__product-amount.bit-kl0xqo.bit-kl0xqo{min-width:80px;text-align:right}.calendar.bit-kl0xqo .basket-panel__product-duration.bit-kl0xqo.bit-kl0xqo{min-width:100px;text-align:right}.calendar.bit-kl0xqo .basket-panel__product-actions.bit-kl0xqo.bit-kl0xqo{display:flex;align-items:center;margin-left:auto;color:var(--bit-ca-secondary-color, #999999)}.calendar.bit-kl0xqo .basket-panel__product-actions.bit-kl0xqo.bit-kl0xqo:hover{color:currentColor;cursor:pointer}.calendar.bit-kl0xqo .basket-panel__booking-btn.bit-kl0xqo>button.bit-kl0xqo{width:220px;height:40px;background-color:var(--bit-ca-accent-color, #5b21b6);color:white;font-weight:700;border:none;border-radius:4px;cursor:pointer}.calendar.bit-kl0xqo .basket-panel__booking-btn.bit-kl0xqo>button.bit-kl0xqo:active{transform:scale(1.01)}.calendar.bit-kl0xqo .basket-panel__booking-btn.bit-kl0xqo>button.bit-kl0xqo:disabled:active{transform:none}.calendar.bit-kl0xqo .basket-panel__booking-btn.bit-kl0xqo>button.bit-kl0xqo:disabled{background-color:#a8a29e;cursor:not-allowed}.calendar.bit-kl0xqo .basket-panel__total-price.bit-kl0xqo.bit-kl0xqo{display:flex;align-items:center;justify-content:center;border-left:1px solid #ccc;width:156px}.calendar.bit-kl0xqo .basket-panel__total-price.bit-kl0xqo>span.bit-kl0xqo{padding:0 2rem;font-size:1.5rem}.calendar__header.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{display:flex;align-items:center}.calendar__day-nav.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{width:60px;display:flex;justify-content:center}.calendar__day-nav-right.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{text-align:right}.calendar__days.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{display:flex;align-items:center;flex:1 1 auto}.calendar__day.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{width:14.2857142857%;text-align:center}.calendar__day.weekend.bit-kl0xqo .calendar__day-name.bit-kl0xqo.bit-kl0xqo,.calendar__day.weekend.bit-kl0xqo .calendar__day-day.bit-kl0xqo.bit-kl0xqo{color:var(--bit-ca-weekend-day-color, rgb(167, 0, 0))}.calendar__rows.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{margin-top:8px}.calendar__row.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{display:flex;height:32px}.calendar__row.bit-kl0xqo:hover .calendar__row-hour.bit-kl0xqo.bit-kl0xqo{font-weight:700;color:var(--bit-ca-bold-color, rgb(70, 70, 70)) !important}.calendar__row.bit-kl0xqo:not(.zero-hour) .calendar__row-hour.bit-kl0xqo.bit-kl0xqo{color:var(--bit-ca-secondary-color, #999999);font-size:11px}.calendar__row-hour.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{width:60px;display:flex;align-items:center;justify-content:center}.calendar__row-slots.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{display:flex;align-items:center;flex:1 1 auto}.calendar__slot.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{width:14.2857142857%;display:flex;align-items:center;justify-content:center;padding:0 10px}.calendar__slot.bit-kl0xqo .slot-btn.bit-kl0xqo.bit-kl0xqo{background-color:#fff;border:1px solid #bbb;width:100%;line-height:1.2rem;border-radius:4px;cursor:pointer;display:flex;align-items:center;justify-content:center}.calendar__slot.bit-kl0xqo .slot-btn.bit-kl0xqo.bit-kl0xqo:hover{border-color:var(--bit-ca-hover-slot-button-border-color, #9d174d);background-color:var(--bit-ca-hover-slot-button-color, #ec4899);color:white}.calendar__slot.bit-kl0xqo .slot-btn--selected.bit-kl0xqo.bit-kl0xqo{border-color:var(--bit-ca-hover-slot-button-border-color, #9d174d);background-color:var(--bit-ca-hover-slot-button-color, #ec4899);color:white}.calendar__slot.bit-kl0xqo .slot-btn .slot-btn-icon{margin-right:0.3rem}.calendar__slot--busy.bit-kl0xqo.bit-kl0xqo.bit-kl0xqo{color:var(--bit-ca-secondary-color, #999999);font-size:12px}.calendar.bit-kl0xqo .bold{font-weight:700;color:var(--bit-ca-bold-color, rgb(70, 70, 70))}.calendar.bit-kl0xqo .h1{font-size:1.5rem;font-weight:500}.calendar.bit-kl0xqo .h2{font-size:1.25rem;font-weight:500}.calendar.bit-kl0xqo .h3{font-size:1.15rem;font-weight:500}.calendar.bit-kl0xqo .rounded{border-radius:8px}.calendar.bit-kl0xqo .pointer{cursor:pointer}.calendar.bit-kl0xqo .hover:hover{background-color:var(--bit-ca-hover-color, #ddd)}.calendar.bit-kl0xqo .inline-block{display:inline-block}.calendar.bit-kl0xqo .btn-icon{display:inline-flex;border-radius:8px;cursor:pointer;padding:0.3rem;color:var(--bit-ca-secondary-color, #999999)}.calendar.bit-kl0xqo .btn-icon:hover{background-color:var(--bit-ca-hover-color, #ddd);color:currentColor}.calendar.bit-kl0xqo .btn-icon:active{transform:scale(1.1)}.calendar.bit-kl0xqo .btn{padding:12px 20px;background-color:var(--bit-ca-accent-color);color:white;font-weight:700;border:none;border-radius:4px;cursor:pointer}.calendar.bit-kl0xqo .btn:disabled{background-color:var(--bit-ca-accent-lighter-color)}.calendar.bit-kl0xqo .flex{display:flex}.calendar.bit-kl0xqo .flex.center{align-items:center;justify-content:center}.calendar.bit-kl0xqo .flex-col{display:flex;flex-direction:column}.calendar.bit-kl0xqo .flex-row{display:flex;flex-direction:row}.calendar.bit-kl0xqo .items-end{align-items:flex-end}.calendar.bit-kl0xqo .items-center{align-items:center}.calendar.bit-kl0xqo .content-center{justify-content:center}.calendar.bit-kl0xqo .content-end{justify-content:end;justify-content:flex-end}.calendar.bit-kl0xqo .error{color:#f87171}.calendar.bit-kl0xqo .success{color:#4ade80}');
}
...
function get_each_context_1(ctx, list, i) {
  const child_ctx = ctx.slice();
  child_ctx[60] = list[i];
  const constants_0 = child_ctx[19](child_ctx[60].date, child_ctx[57].hh, child_ctx[57].mm);
  child_ctx[61] = constants_0;
  const constants_1 = child_ctx[11][child_ctx[61]];
...
function create_if_block_8(ctx) {
  ...
  bookingmodal.$on("close", ctx[34]);
  bookingmodal.$on("overlayClick", ctx[35]);
  return {
    c() {
...
function create_default_slot_2(ctx) {
  ...
  bookingconfirm.$on("ok", ctx[22]);
  bookingconfirm.$on("error", ctx[23]);
  return {
    c() {
    ...
    p(ctx2, dirty) {
      ...
      if (dirty[0] & 8)
        bookingconfirm_changes.activeSection = ctx2[3];
      if (dirty[0] & 1)
        bookingconfirm_changes.placeName = ctx2[0];
      if (dirty[0] & 2)
        bookingconfirm_changes.placeAddress = ctx2[1];
...
function create_if_block_5(ctx) {
  ...
  return {
    c() {
      ...
      attr(div, "class", "basket-panel__section-tabs bit-kl0xqo");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      for (let i = 0; i < each_blocks.length; i += 1) {
...
function create_each_block_4(ctx) {
  let div;
  let t0_value = ctx[70].name + "";
  let t0;
  let t1;
  let mounted;
  let dispose;
  function click_handler_2() {
    return ctx[42](ctx[70]);
  }
  return {
    c() {
      div = element("div");
      t0 = text(t0_value);
      t1 = space();
      attr(div, "class", "basket-panel__section-tab bit-kl0xqo");
      toggle_class(div, "tab-active", ctx[3] === ctx[70]);
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, t0);
    ...
    p(new_ctx, dirty) {
      ctx = new_ctx;
      if (dirty[0] & 16 && t0_value !== (t0_value = ctx[70].name + ""))
        set_data(t0, t0_value);
      if (dirty[0] & 24) {
        toggle_class(div, "tab-active", ctx[3] === ctx[70]);
      }
...
function create_each_block_3(ctx) {
  let div5;
  let div0;
  let t0_value = ctx[67].day + "";
  let t0;
  let t1;
  let div1;
  let t2_value = ctx[67].fromToName + "";
  let t2;
  let t3;
  let div2;
  let t4_value = ctx[67].duration + "";
  let t4;
  let t5;
  let div3;
  let fmtCurrency_action;
  ...
  return {
    c() {
      ...
      div4 = element("div");
      create_component(icon.$$.fragment);
      attr(div0, "class", "basket-panel__product-day bit-kl0xqo");
      attr(div1, "class", "basket-panel__product-time bit-kl0xqo");
      attr(div2, "class", "basket-panel__product-duration bit-kl0xqo");
      attr(div3, "class", "basket-panel__product-amount bit-kl0xqo");
      attr(div4, "class", "basket-panel__product-actions bit-kl0xqo");
      attr(div5, "class", "basket-panel__product bit-kl0xqo");
    },
    m(target, anchor) {
      ...
      current = true;
      if (!mounted) {
        dispose = action_destroyer(fmtCurrency_action = fmtCurrency.call(null, div3, ctx[67].amount));
        mounted = true;
      }
    },
    p(new_ctx, dirty) {
      ctx = new_ctx;
      if ((!current || dirty[0] & 1024) && t0_value !== (t0_value = ctx[67].day + ""))
        set_data(t0, t0_value);
      if ((!current || dirty[0] & 1024) && t2_value !== (t2_value = ctx[67].fromToName + ""))
        set_data(t2, t2_value);
      if ((!current || dirty[0] & 1024) && t4_value !== (t4_value = ctx[67].duration + ""))
        set_data(t4, t4_value);
      if (fmtCurrency_action && is_function(fmtCurrency_action.update) && dirty[0] & 1024)
...
function create_each_block_2(ctx) {
  let div2;
  let div0;
  let t0_value = ctx[60].name + "";
  let t0;
  let t1;
  let div1;
  let t2_value = ctx[60].day + "";
  let t2;
  let t3;
  return {
    c() {
      ...
      t2 = text(t2_value);
      t3 = space();
      attr(div0, "class", "calendar__day-name bold bit-kl0xqo");
      attr(div1, "class", "calendar__day-day bit-kl0xqo");
      attr(div2, "class", "calendar__day bit-kl0xqo");
      toggle_class(div2, "weekend", ctx[60].weekend);
    },
    m(target, anchor) {
      insert(target, div2, anchor);
      append(div2, div0);
    ...
    p(ctx2, dirty) {
      if (dirty[0] & 4 && t0_value !== (t0_value = ctx2[60].name + ""))
        set_data(t0, t0_value);
      if (dirty[0] & 4 && t2_value !== (t2_value = ctx2[60].day + ""))
        set_data(t2, t2_value);
      if (dirty[0] & 4) {
        toggle_class(div2, "weekend", ctx2[60].weekend);
      }
    },
    d(detaching) {
      if (detaching)
...
function create_else_block(ctx) {
  ...
  return {
    c() {
      ...
      span = element("span");
      t = space();
      attr(div, "class", "calendar__slot calendar__slot--busy bit-kl0xqo");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, span);
      append(div, t);
      if (!mounted) {
        dispose = action_destroyer(fmtCurrency_action = fmtCurrency.call(null, span, ctx[62].amount));
        mounted = true;
      }
    },
    p(new_ctx, dirty) {
      ctx = new_ctx;
      if (fmtCurrency_action && is_function(fmtCurrency_action.update) && dirty[0] & 2052)
        fmtCurrency_action.update.call(null, ctx[62].amount);
    },
    i: noop,
    o: noop,
    d(detaching) {
...
function create_if_block_1(ctx) {
  ...
  let mounted;
  let dispose;
  let if_block = ctx[62].selected && create_if_block_2();
  function click_handler_5() {
    return ctx[45](ctx[62]);
  }
  return {
    c() {
      div = element("div");
      ...
      t1 = space();
      attr(button, "type", "button");
      attr(button, "class", "slot-btn bit-kl0xqo");
      toggle_class(button, "slot-btn--selected", ctx[62].selected);
      attr(div, "class", "calendar__slot bit-kl0xqo");
    },
    m(target, anchor) {
      insert(target, div, anchor);
      append(div, button);
      ...
      if (!mounted) {
        dispose = [
          action_destroyer(fmtCurrency_action = fmtCurrency.call(null, span, ctx[62].amount)),
...
function create_each_block_1(ctx) {
  let if_block_anchor;
  let current;
  let if_block = ctx[62] && create_if_block(ctx);
  return {
    c() {
      if (if_block)
        if_block.c();
...
function create_each_block(ctx) {
  let div3;
  let div0;
  let t0_value = ctx[57].displayHour + "";
  let t0;
  let t1;
  let div1;
  let t2;
  let div2;
  let t3_value = ctx[57].displayHour + "";
  let t3;
  let t4;
  let current;
  ...
  return {
    c() {
      ...
      t3 = text(t3_value);
      t4 = space();
      attr(div0, "class", "calendar__row-hour calendar__row-hour-left bit-kl0xqo");
      attr(div1, "class", "calendar__row-slots bit-kl0xqo");
      attr(div2, "class", "calendar__row-hour calendar__row-hour-right bit-kl0xqo");
      attr(div3, "class", "calendar__row bit-kl0xqo");
      toggle_class(div3, "zero-hour", ctx[57].zero);
    },
    m(target, anchor) {
      insert(target, div3, anchor);
      append(div3, div0);
...
function create_fragment(ctx) {
  ...
  let if_block1 = ctx[6] && create_if_block_7(ctx);
  let if_block2 = ctx[7] && create_if_block_6(ctx);
  let if_block3 = ctx[8] && create_if_block_5(ctx);
  let each_value_3 = ctx[10].bookingsArray;
  let each_blocks_2 = [];
  ...
  let if_block4 = !ctx[10].bookingsArray.length && create_if_block_4();
  let if_block5 = ctx[9] && create_if_block_3(ctx);
  ...
  return {
    c() {
      ...
      attr(div0, "class", "basket-panel__products bit-kl0xqo");
      attr(span, "class", "bit-kl0xqo");
      attr(div1, "class", "basket-panel__total-price bit-kl0xqo");
      attr(div2, "class", "basket-panel__basket bit-kl0xqo");
      attr(button, "type", "button");
      button.disabled = button_disabled_value = ctx[10].totalAmount <= 0;
      attr(button, "class", "bit-kl0xqo");
      attr(div3, "class", "basket-panel__booking-btn bit-kl0xqo");
      attr(div4, "class", "basket-panel__summary bit-kl0xqo");
      attr(div5, "class", "basket-panel bit-kl0xqo");
      attr(div6, "class", "calendar__day-nav calendar__day-nav-left bit-kl0xqo");
      attr(div7, "class", "calendar__days bit-kl0xqo");
      attr(div8, "class", "btn-icon");
      attr(div9, "class", "calendar__day-nav calendar__day-nav-right bit-kl0xqo");
      attr(div10, "class", "calendar__header bit-kl0xqo");
      attr(div11, "class", "calendar__rows bit-kl0xqo");
      attr(div12, "class", "calendar bit-kl0xqo");
    },
    m(target, anchor) {
      ...
      append(div10, div9);
      append(div9, div8);
      mount_component(icon, div8, null);
      append(div12, t11);
      append(div12, div11);
      for (let i = 0; i < each_blocks.length; i += 1) {
      ...
      if (!mounted) {
        dispose = [
          action_destroyer(fmtCurrency_action = fmtCurrency.call(null, span, ctx[10].totalAmount)),
          listen(button, "click", ctx[44]),
          listen(div8, "click", ctx[20])
        ];
        mounted = true;
      }
    },
    p(ctx2, dirty) {
      ...
      if (dirty[0] & 263168) {
        each_value_3 = ctx2[10].bookingsArray;
        let i;
      ...
      if (!ctx2[10].bookingsArray.length) {
        if (if_block4)
          ;
        else {
      ...
      if (fmtCurrency_action && is_function(fmtCurrency_action.update) && dirty[0] & 1024)
        fmtCurrency_action.update.call(null, ctx2[10].totalAmount);
      if (!current || dirty[0] & 1024 && button_disabled_value !== (button_disabled_value = ctx2[10].totalAmount <= 0)) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, storeSlots, (value) => $$invalidate(11, $storeSlots = value));
  component_subscribe($$self, selectedSlots, (value) => $$invalidate(10, $selectedSlots = value));
  let viewDays = generateViewDays(new Date(startDate));
  let viewHours = generateHours(startHour, deltaHour);
  ...
  function setActiveSectionTab(tab) {
    $$invalidate(3, activeSection = tab);
    clearStore();
  }
  ...
  function generateViewDays(from) {
  ...
  function loadNextWeek() {
    ...
    $$invalidate(2, viewDays = generateViewDays(addDays(date2, 1)));
  }
  function loadPrevWeek() {
    const { date: date2 } = viewDays[0];
    $$invalidate(2, viewDays = generateViewDays(addDays(date2, -7)));
  }
  function successBooking() {
    $$invalidate(5, showConfirmBooking = false);
    $$invalidate(6, showSuccessBooking = true);
    refreshSlots();
    clearStore();
  }
  function errorBooking(e) {
    $$invalidate(5, showConfirmBooking = false);
    $$invalidate(7, showErrorBooking = true);
    refreshSlots();
    clearStore();
  }
  const close_handler = () => $$invalidate(5, showConfirmBooking = false);
  const overlayClick_handler = () => $$invalidate(5, showConfirmBooking = false);
  const click_handler = () => $$invalidate(6, showSuccessBooking = false);
  const close_handler_1 = () => $$invalidate(6, showSuccessBooking = false);
  const overlayClick_handler_1 = () => $$invalidate(6, showSuccessBooking = false);
  const click_handler_1 = () => $$invalidate(7, showErrorBooking = false);
  const close_handler_2 = () => $$invalidate(7, showErrorBooking = false);
  const overlayClick_handler_2 = () => $$invalidate(7, showErrorBooking = false);
  const click_handler_2 = (tab) => setActiveSectionTab(tab);
  const click_handler_3 = (book) => removeSelectedBooking(book);
  const click_handler_4 = () => $$invalidate(5, showConfirmBooking = true);
  const click_handler_5 = (slot) => onSlotClick(slot);
  $$self.$$set = ($$props2) => {
    if ("placeName" in $$props2)
      $$invalidate(0, placeName = $$props2.placeName);
    if ("placeAddress" in $$props2)
      $$invalidate(1, placeAddress = $$props2.placeAddress);
    if ("startDate" in $$props2)
      $$invalidate(24, startDate = $$props2.startDate);
    if ("startHour" in $$props2)
      $$invalidate(25, startHour = $$props2.startHour);
    if ("deltaHour" in $$props2)
      $$invalidate(26, deltaHour = $$props2.deltaHour);
    if ("viewDaysCount" in $$props2)
      $$invalidate(27, viewDaysCount = $$props2.viewDaysCount);
    if ("getSlots" in $$props2)
      $$invalidate(28, getSlots = $$props2.getSlots);
    if ("getTimeZone" in $$props2)
      $$invalidate(29, getTimeZone = $$props2.getTimeZone);
    if ("getSections" in $$props2)
      $$invalidate(30, getSections = $$props2.getSections);
    if ("postBooking" in $$props2)
      $$invalidate(31, postBooking = $$props2.postBooking);
  };
  $$self.$$.update = () => {
    var _a;
    if ($$self.$$.dirty[0] & 4) {
      $$invalidate(9, showPrevBtn = ((_a = viewDays[0]) == null ? void 0 : _a.date) > minDate);
    }
    if ($$self.$$.dirty[0] & 4) {
      $$invalidate(33, slotsFromDate = viewDays[0].date);
    }
    if ($$self.$$.dirty[0] & 4) {
      $$invalidate(32, slotsToDate = addDays(viewDays[viewDays.length - 1].date, 1));
    }
    if ($$self.$$.dirty[0] & 1073741824) {
      $$invalidate(4, sectionsTab = getSections());
    }
    if ($$self.$$.dirty[0] & 16) {
      $$invalidate(8, hasSections = (sectionsTab == null ? void 0 : sectionsTab.length) > 0);
    }
    if ($$self.$$.dirty[0] & 16) {
      $$invalidate(3, activeSection = sectionsTab[0]);
    }
    if ($$self.$$.dirty[0] & 8 | $$self.$$.dirty[1] & 6) {
...
function createCalendar(el, options) {
  ...
  function postBooking(contact, bookings, section) {
